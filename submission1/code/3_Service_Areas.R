...
for (y in 2006:2015) {
  ...
  for (m in monthlist) {
    ...
    ma.path=paste0("C:/Users/mirac/Documents/GitHub/econ470_ma/hw4/data/input/monthly-ma-contract-service-area/MA_Cnty_SA_",y,"_",m,".csv")
...
write_rds(contract.service.area,"C:/Users/mirac/Documents/GitHub/econ470_ma/hw4/data/output/contract_service_area.rds")